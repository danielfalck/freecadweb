...
#*   modified by Daniel Falck <ddfalck@gmail.com>                          *
...
#            rgb = "#f85500" # test color
        ...
        if wireframeMode == "faceloop":
            ...
            result += "0x555555, wireframe: true, transparent: true } );\n"
...
#                            result += tab+"wire.vertices.push(new THREE.Vector3("
                            print "wire.vertices.push(new THREE.Vector3("
#                            result += str(edge.Vertexes[1].X)+", "+str(edge.Vertexes[1].Y)+", "+str(edge.Vertexes[1].Z)+"));\n"
                            print str(edge.Vertexes[1].X)+", "+str(edge.Vertexes[1].Y)+", "+str(edge.Vertexes[1].Z)+"));\n"
...
def getTemplate():
    ...
    result = """<!DOCTYPE html>
		...
		renderer.setSize(SCREEN_WIDTH/2.0 , SCREEN_HEIGHT/2.0);
                // Set the background color of the renderer to black, with full opacity
                renderer.setClearColorHex(0x000000, 1);
                //renderer.setClearColorHex(0x9797AA, 1);
